...
export const CHUTE = {
  // 경사로 (정지 강체, 미끄러운 재질). 뒤에서 앞으로 완만히 내려온다.
  topY: 2.55,
  topZ: -2.15,
  endY: 2.37,
  endZ: -1.4,
  ...
  friction: 0.06,
  restitution: 0.02,
  // 스토퍼: 경사로에서 튀어나온 코인의 전진을 끊어 제자리에 떨어뜨린다.
  // 실제 기계의 슈트 끝 립과 같은 역할.
  stopZ: -1.02,
  stopBottomY: 1.55,
  stopTopY: 2.5,
...
export const CAMERA = {
  ...
  //  - 반폭 1.5 = 좌우 벽 바깥면
  //  - 반높이 3.15 = 투입구(y 2.72, z -1.98)까지 담기는 세로 투영
  //    세로 화면에서는 가로가 제약이라 이 값이 커져도 손해가 없다.
  fitHalfW: 1.5,
  fitHalfH: 3.15,
  fitPad: 1.04,
};
